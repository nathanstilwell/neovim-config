...
-- Resize splits // instead of using a remap, use the `:resize` or `:vertical resize` commands
-- :resize [rows: number | +increment:number]
-- :vertical resize [cols:number | +increment: nubmer]
